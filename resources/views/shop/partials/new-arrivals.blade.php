...
<section id="new-arrivals" class="relative overflow-hidden bg-white">
                    ...
                    @foreach ($featured as $product)
                        <div data-na-item
                            ...
                            <a href="{{ route('shop.show', $product->slug) }}"
                                ...
                                @else
                                    <div
                                        class="w-full h-full flex items-center justify-center bg-neutral-100 text-[10px] uppercase tracking-[0.2em] text-neutral-400">
                                        No Image
                                    </div>
                                @endif
        ...
        @else
            ...
            <div
                ...
                <p class="text-neutral-500 font-medium text-center">
                    New arrivals will be added soon.
                </p>
                <a href="{{ route('shop.index') }}"
