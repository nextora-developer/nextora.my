{{-- Trust Banner --}}
<section class="relative pt-16 lg:pt-16 bg-[#F9F7F2] ">
    ...
    <div
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
            ...
            {{-- character --}}
            <div class="hidden lg:block absolute left-[50px] bottom-[25px] z-20 pointer-events-none">
            ...
            {{-- mobile character --}}
            <div class="lg:hidden absolute left-1/2 -translate-x-1/2 -top-10 z-20 pointer-events-none">
                <img src="{{ asset('images/trust-character.png') }}" alt="Trust Character"
                    class="w-auto h-[190px] object-contain drop-shadow-[0_20px_35px_rgba(0,0,0,0.22)]">
            </div>
